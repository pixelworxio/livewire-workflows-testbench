    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <p class="text-gray-600 mb-8">Step 4 of 4: Confirm Your Appointment</p>

                <!-- Appointment Summary -->
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6 mb-6">
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">Appointment Summary</h3>

                    <div class="space-y-4">
                        <!-- Service -->
                        @if($service)
                            <div class="flex items-start">
                                <div class="w-24 text-gray-600 font-medium">Service:</div>
                                <div class="flex-1">
                        ...
                        <!-- Provider -->
                        @if($provider)
                            <div class="flex items-start border-t border-blue-200 pt-4">
                                <div class="w-24 text-gray-600 font-medium">Provider:</div>
                                <div class="flex-1">
                        ...
                        @if($scheduledDateTime)
                            <div class="flex items-start border-t border-blue-200 pt-4">
                                <div class="w-24 text-gray-600 font-medium">When:</div>
                                <div class="flex-1">
                                    <p class="font-semibold text-gray-900">{{ $scheduledDateTime->format('l, F j, Y') }}</p>
                                    <p class="text-sm text-gray-600">{{ $scheduledDateTime->format('g:i A') }}</p>
                                </div>
                            </div>
                        @endif
                    </div>
